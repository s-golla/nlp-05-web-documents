"""
src/nlp/pipeline_web_html_sgolla.py - Module 5 Script
...
Run from root project folder with:
  ...
  uv run python -m nlp.pipeline_web_html_sgolla
"""
...
from nlp.stage02_validate_sgolla import run_validate
from nlp.stage03_transform_sgolla import run_transform
